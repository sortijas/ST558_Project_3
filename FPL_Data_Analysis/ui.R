    ...
    tabItem(tabName = "about",
            tabsetPanel(
              ...
              tabPanel("Features",
                       ...
                       h3("Model"),
                       h4("Select between multiple linear regression and boosted trees supervised learning methods. Users can select method-specific inputs and tuning parameters. Outputs include: Plots of residuals vs fitted data (multiple linear regression) or relative influences of variables (boosted trees), root mean squared errors (RMSE, see formula below) for testing data set, and model fit summaries."),
            ...
            fluidRow(
              column(3,
                     box(width = 12, title = "Model Parameters",
                         ...
                         checkboxInput("centerModel", tags$b("Center and Scale Data"), value = TRUE),
                         conditionalPanel(
